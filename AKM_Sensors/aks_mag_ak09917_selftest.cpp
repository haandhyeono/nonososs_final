 ...
 */
int16_t ak09917_self_test(int32_t *result)
{
    int16_t fret;
    ...
    *result = 0;
    ...
    xval_i16 = MAKE_S16(i2cData[1], i2cData[2]);
    yval_i16 = MAKE_S16(i2cData[3], i2cData[4]);
    zval_i16 = MAKE_S16(i2cData[5], i2cData[6]);

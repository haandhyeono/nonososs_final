...
#define TLIMIT_LO_RST_WIA2   0xa3
#define TLIMIT_HI_RST_WIA2   0xa3
 ...
 */
int16_t ak09940a_self_test(int32_t *result)
{
    int16_t fret;
    ...
    *result = 0;
    ...
    /* Maximum time for measurement is 3.1 ms */
    /* Refer to datasheet p.9 */
    AKH_DelayMilli(5);
